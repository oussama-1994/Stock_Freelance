...
class CreateFabricationPfTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fabrication_pf', function (Blueprint $table) {
            $table->id();
            $table->string('code_PF');
            $table->decimal('quantite',15,9);
    ...
    {
        Schema::table('fabrication_pf', function (Blueprint $table) {
            //
        });
    }
}
