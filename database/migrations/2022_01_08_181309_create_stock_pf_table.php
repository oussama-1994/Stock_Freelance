...
class CreateStockPfTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('stock_pf', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('stock_pf', function (Blueprint $table) {
            //
        });
    }
}
